...
{
    function NaCheckTranslation()
    {
    }

    function operatorList()
    {
        return array( 'nachecktranslation' );
    }
    ...
    {
        return array( 'nachecktranslation' => array( 'dataKey' => array( 'type' => 'string',
                                                          'required' => true,
                                                          'default' => '' ),
    ...
    function modify( $tpl, $operatorName, $operatorParameters, &$rootNamespace, &$currentNamespace, &$operatorValue, &$namedParameters )
    {
		...
		try {
				...
				$dataLanguage = $parseFile->checkTranslation();	
				foreach( $dataLanguage as $key => $TextTranslated){
					$lang = eZContentLanguage::fetch ( $idlanguage );
					
					$operatorValue = (string)$TextTranslated;
				}
